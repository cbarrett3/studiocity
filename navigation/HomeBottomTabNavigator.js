...
export const HomeBottomTabNavigator = () => {
   return (
      <BottomTab.Navigator tabBar={props => <HomeBottomTab {...props} />}>
         ...
         <BottomTab.Screen name='CONNECT' component={Connect} options={{title:"CONNECT", tabBarIcon: ConnectIcon}}/>
         <BottomTab.Screen name='DM' component={DM} options={{title:"DM", tabBarIcon: DirectMessageIcon}}/>
